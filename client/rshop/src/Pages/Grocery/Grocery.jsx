...
const Grocery = () => {
  ...
  useEffect(() => {
    dispatch(fetchProducts({ search: searchQuery, category_id: "12" }));
        ...
        <header className="results-header">
          <div className="search-info">
            {isLoading ? (
              ...
              <h1>Discover Grocery Products</h1>
            )}
          </div>
        ...
        <section className="products-grid-container">
          {isLoading ? (
            <div className="loading">
              ...
              <span>Finding best grocery products for you...</span>
            </div>
          ) : error ? (
            ...
            <div className="products-grid">
              {products.length > 0 ? (
                ...
                <div className="empty">
                  <h2>No grocery products found</h2>
