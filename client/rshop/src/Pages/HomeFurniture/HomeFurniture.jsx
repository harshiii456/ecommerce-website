...
const HomeFurniture = () => {
  ...
  useEffect(() => {
    dispatch(fetchProducts({ search: searchQuery, category_id: "10" }));
        ...
        <section className="products-grid-container">
          {isLoading ? (
            <div className="loading">
              ...
              <span>Finding best home & furniture products for you...</span>
            </div>
          ) : error ? (
            ...
            <div className="products-grid">
              {products.length > 0 ? (
                ...
                <div className="empty">
                  <h2>No home & furniture products found</h2>
