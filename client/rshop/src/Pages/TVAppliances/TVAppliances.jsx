...
const TVAppliances = () => {
  ...
  useEffect(() => {
    dispatch(fetchProducts({ search: searchQuery, category_id: "15" }));
        ...
        <section className="products-grid-container">
          {isLoading ? (
            <div className="loading">
              ...
              <span>Finding best TVs & appliances for you...</span>
            </div>
          ) : error ? (
