...
async function addFashionCategory() {
  try {
    console.log("=== ADDING FASHION CATEGORY ===");
    ...
    if (!existingCategory) {
      ...
      console.log(`✅ Created Fashion category with ID: ${fashionCategory.category_id}`);
      
      // Now add fashion products with the correct category_id
      ...
      console.log(`⚠️  Fashion category already exists with ID: ${existingCategory.category_id}`);
    }

    console.log("=== FASHION CATEGORY AND PRODUCTS ADDED SUCCESSFULLY ===");
  } catch (error) {
